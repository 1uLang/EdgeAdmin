Tea.context(function () {
    ...
    this.tableData = [
        {id:1,postId:"LAN",intIP:"192.168.0.1",outIP:"192.168.1.1",targetIP:"192.168.3.1",desc:"描述",status:1,postIndex:1,typeIndex:1,sourceTypeIndex:1,targetIndex:1,sourceValue:"源的值"},
        {id:2,postId:"WAN",intIP:"192.168.0.2",outIP:"192.168.1.2",targetIP:"192.168.3.2",desc:"描述",status:2,postIndex:2,typeIndex:1,sourceTypeIndex:1,targetIndex:1,sourceValue:"源的值"},
        {id:3,postId:"LAN",intIP:"192.168.0.3",outIP:"192.168.1.3",targetIP:"192.168.3.3",desc:"描述",status:1,postIndex:1,typeIndex:1,sourceTypeIndex:1,targetIndex:1,sourceValue:"源的值"},
        {id:4,postId:"LAN",intIP:"192.168.0.4",outIP:"192.168.1.4",targetIP:"192.168.3.4",desc:"描述",status:2,postIndex:3,typeIndex:1,sourceTypeIndex:1,targetIndex:1,sourceValue:"源的值"}
    ]
